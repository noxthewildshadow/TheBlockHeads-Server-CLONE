...
echo "================================================================"
echo "NEXT STEPS:"
echo "1. Create a world with: ./blockheads_server171 -n"
echo "   - See all world creation options: ./blockheads_server171 -h"
echo "   - After world creation, press Ctrl+C to exit"
echo "2. Start your server with: ./start_server.sh start WORLD_NAME PORT"
echo "3. Connect to your server in The Blockheads game"
echo ""
echo "TROUBLESHOOTING:"
echo "- If you can't connect, check your firewall settings"
echo "- Make sure the port you choose is open on your router"
echo "- Check server status with: ./start_server.sh status"
echo "================================================================"
